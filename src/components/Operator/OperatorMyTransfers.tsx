...
const OperatorMyTransfers = () => {
	...
	const [unitNum, setUnitNum] = useState<string | null>(
		null,
	);
	...
	const fetchUnitNum = async () => {
		const storedUnitNum = await AsyncStorage.getItem(
			'unitNum',
		);
